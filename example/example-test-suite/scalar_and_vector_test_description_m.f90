...
module scalar_and_vector_test_description_test_m
  ...
  private
  public :: scalar_and_vector_test_description_test_t

  type, extends(test_t) :: scalar_and_vector_test_description_test_t
  contains
...
end module scalar_and_vector_test_description_test_m
