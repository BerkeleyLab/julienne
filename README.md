...
------------------|---------------|--------|------------------------------------------------------------
LLVM/[Caffeine]   |22             |parallel|`fpm test --compiler flang --flag "-O3 -DHAVE_MULTI_IMAGE_SUPPORT -fcoarray -DASSERT_MULTI_IMAGE" --link-flag "-lcaffeine -lgasnet-smp-seq -L<caffeine-prefix>/lib"` (\*)
